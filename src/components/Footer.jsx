      ...
      <div className='max-w-screen-xl px-4 py-16 mx-auto space-y-8 sm:px-6 lg:space-y-16 lg:px-8'>
        <div className='grid grid-cols-1 gap-8 lg:grid-cols-3'>
            ...
            <ul className='flex gap-6 mt-8'>
              <li>
                <a href='/' rel='noreferrer' target='_blank' className='text-white transition hover:opacity-75'>
                  ...
                  <span> <img src={facebook} alt='face' /> </span>
          ...
          <div className='grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4'>
            <div>
              <p className='font-medium text-white'>Explora</p>
            ...
            <div>
              <p className='font-medium text-white'>Información</p>
            ...
            <div>
              <p className='font-medium text-white'>Únete a nosotros</p>
              <nav aria-label='Footer Navigation - Company' className='mt-6'>
                <ul className='space-y-4 text-sm'>
                  <li>
                    <a href='#' className='text-white transition hover:opacity-75'>
        ...
        <p className='text-xs text-white'>
          © 2023. Tonal. Todos los derechos reservados.
        </p>
      </div>
    </footer>
